...
export default function LampDemo() {
  return (
    // LampContainer wraps the content, applying background and layout styles.
    <LampContainer>
      {/* Animated heading using Framer Motion */}
      <motion.h1
        initial={{ opacity: 0.5, y: 0 }} // Initial animation state: partially transparent and shifted down.
