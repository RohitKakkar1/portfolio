...
const CameraHandler = ({ slideDistance }) => {
  ...
  }, [viewport, slide, slideDistance]); // Add slide and slideDistance to the dependency array
  ...
  }, [slide, moveToSlide]); // Add moveToSlide to the dependency array
