...
const state = proxy({
  clicked: null,
  urls: [1, 2, 3, 4, 5, 6, 7].map((u) => `/${u}.jpg`)
})
...
function Item({ index, position, scale, c = new THREE.Color(), ...props }) {
  ...
  return <Image ref={ref} {...props} position={position} scale={scale} onClick={click} onPointerOver={click} onPointerOut={out} />
}
...
export const CareerTimeline = () => (
  <Canvas style={{
    width: '80%',
    height: '80%',
    background: '#D5D5D5', // Set background to white
  }} gl={{ antialias: false }} dpr={[1, 1.5]} onPointerMissed={() => (state.clicked = null)}>
    <Items />
  </Canvas>
)
