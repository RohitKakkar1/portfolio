...
const CameraControls = () => {
    ...
    const lookAtPoints = [
        new THREE.Vector3(0, 0, -50), // Look at here when the camera is at point 0
        new THREE.Vector3(0, 0, -7), // Look at here when the camera is at point 1
        new THREE.Vector3(0, 0, -5), // Look at here when the camera is at point 2
    ];

    const targetRef = useRef(new THREE.Vector3(0, 2, -10)); // Initial lookAt target
