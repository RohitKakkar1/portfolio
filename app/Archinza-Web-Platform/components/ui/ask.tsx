...
<h1 className="text-4xl font-bold mb-6 text-black text-center">Here's what you can do</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {sections.map((section) => (
          <div key={section.id} className="text-center">
            ...
            >
              <div className="bg-white  mx-auto w-[fit] h-[350px] overflow-hidden rounded-2xl">
                <img 
                  src={hoveredSection === section.id ? section.hoverImage : section.defaultImage}
                  alt={section.title}
                  className="w-full h-full object-cover transition-all duration-500 ease-in-out rounded-2xl"
                />
              </div>
            </div>
